    ...
    <div class="crop-container" v-show="openCrop">
      ...
      >
        ...
        >
          ...
          <span
            class="crop-corner crop-corner__right-top"
            ref="rightTop"
          ></span>
          <span
            class="crop-corner crop-corner__right-bottom"
            ref="rightBottom"
          ></span>
          <span
            class="crop-corner crop-corner__left-bottom"
            ref="leftBottom"
          ></span>
          <!-- 防止图片被选中 -->
